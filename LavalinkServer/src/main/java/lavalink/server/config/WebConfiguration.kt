...
import lavalink.server.video.VideoConfig
...
class WebConfiguration(
    private val interceptors: List<RestInterceptor>,
    ...
    override fun addCorsMappings(registry: org.springframework.web.servlet.config.annotation.CorsRegistry) {
        registry.addMapping("/magma/v1/videos/**")
            .allowedOriginPatterns(*videoConfig.allowedOrigins.toTypedArray())
