...
val archivesBaseName = "MagmaLink"
group = "dev.arbjerg.lavalink"
description = "A Lavalink-compatible audio and video streaming node"
...
tasks {
    ...
    processResources {
        val tokens = mapOf(
            ...
            "project.artifactId" to "MagmaLink-Server",
    ...
    withType<BootJar> {
        archiveFileName = "MagmaLink.jar"

        if (findProperty("targetPlatform") == "musl") {
            archiveFileName = "MagmaLink-musl.jar"
...
mavenPublishing {
    ...
    pom {
        name = "MagmaLink Server"
        description = "Lavalink-compatible audio and video streaming server"
    }
}
