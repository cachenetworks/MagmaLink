---
description: MagmaLink getting started guide.
---

# Getting Started

Welcome to the MagmaLink Getting Started guide. If you're new to MagmaLink, follow these steps to get started:

## Prerequisites

Before you start, make sure you have picked an up-to-date Lavalink-compatible client. You can find a list of clients on the [clients](../clients.md) page.
...
To run MagmaLink as a standalone binary, follow the steps [here](binary.md).
...
Running MagmaLink as a systemd service makes sure that MagmaLink is always running and restarts it if it crashes.
